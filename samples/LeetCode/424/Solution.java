...
public class Solution {
  public static void main(String[] args) {
    out.println(characterReplacement(in.next(),in.nextInt()));
  }
  ...
  public static boolean checkFreqs(int[]freqs, int k){
    int iMaxFreq=0;
    int maxFreq=0;
    int sumFreq=0;
    ...
    return sumFreq-freqs[iMaxFreq]<=k;
  }
